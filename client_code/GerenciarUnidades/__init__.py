...
class GerenciarUnidades(GerenciarUnidadesTemplate):
  ...
  def btn_nova_unidade_click(self, **event_args):
    ...
    if save_clicked:
      novos_dados = {
        'nome': edicao_form.txt_nome.text, 'cidade': edicao_form.txt_cidade.text,
        'estado': edicao_form.drp_estado.selected_value, 'endereco': edicao_form.txt_endereco.text,
        'cep': edicao_form.txt_cep.text, 'telefone': edicao_form.txt_telefone.text,
